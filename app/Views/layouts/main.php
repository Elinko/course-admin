...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/main.css?v1.17" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/datepicker.css?v1.17" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/custom.css?v1.17" />
	...
	<body class="is-preload">
		...
		<!-- Scripts -->
			...
			<script src="<?php echo base_url(); ?>/assets/js/custom.js?v1.17"></script>
